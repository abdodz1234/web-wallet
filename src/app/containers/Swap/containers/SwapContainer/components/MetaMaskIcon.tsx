...
export const MetaMaskIcon = ({ size = 20 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 35 33"
  ...
  >
    <g strokeLinecap="round" strokeLinejoin="round" strokeWidth=".25">
      ...
      <path d="m2.66296 1 13.01714 9.809-2.3254-5.81802z" fill="#e27625" stroke="#e27625" />
      <path d="m28.2295 23.5335-3.4947 5.3386 7.4829 2.0603 2.1436-7.2823z" fill="#e27625" stroke="#e27625" />
      <path d="m1.27281 23.6501 2.13055 7.2823 7.46994-2.0603-3.48166-5.3386z" fill="#e27625" stroke="#e27625" />
      <path d="m10.4706 14.5149-2.0786 3.1358 7.405.3369-.2469-7.969z" fill="#e27625" stroke="#e27625" />
      <path d="m25.1505 14.5149-5.1575-4.58704-.1688 8.05974 7.4049-.3369z" fill="#e27625" stroke="#e27625" />
      <path d="m10.8733 28.8721 4.4819-2.1639-3.8583-3.0062z" fill="#e27625" stroke="#e27625" />
      <path d="m20.2659 26.7082 4.4689 2.1639-.6105-5.1701z" fill="#e27625" stroke="#e27625" />
